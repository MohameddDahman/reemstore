  ...
  return (
    <div className="relative inline-block max-w-full">
      <style>{`
        ...
        @property --rg-color-1 { syntax: '<color>'; initial-value: #121010; inherits: false; }
        @property --rg-color-2 { syntax: '<color>'; initial-value: #a80f26; inherits: false; }
        @property --rg-color-3 { syntax: '<color>'; initial-value: #d7263d; inherits: false; }
        @property --rg-color-4 { syntax: '<color>'; initial-value: #ffc9c9; inherits: false; }
        @property --rg-color-5 { syntax: '<color>'; initial-value: hsl(350 70% 4%); inherits: false; }
        ...
        .rg-button {
          ...
          position: relative;
          /* No fixed min-width: it overflowed narrow viewports. Horizontal
             padding gives the button its size instead. */
          min-width: 0;
          max-width: 100%;
          min-height: 51px;
          padding: 14px 32px;
